...
reference_csv_path = # this should be the csv. file path for your reference/model answers
generated_csv_path = # this should be the csv. file path for your AI generated model answers
