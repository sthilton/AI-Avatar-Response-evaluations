...
generated_file = 'path_to/HPLCpanishTrained.csv' 
reference_file = 'path_to/ModelAnswerSpanish.csv' 
...
# Calculate BERT scores using a model that supports Spanish (multilingual BERT) 
P, R, F1 = score(generated_answers, reference_answers, lang='es', model_type='bert-base-multilingual-cased', verbose=True) 
